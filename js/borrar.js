const MAXIMOS_INTENTOS = 14, // Intentos máximos que tiene el jugador
  COLUMNAS = 12, // Columnas del memorama
  SEGUNDOS_ESPERA_VOLTEAR_IMAGEN = 1.25, // Por cuántos segundos mostrar ambas imágenes
  NOMBRE_IMAGEN_OCULTA = "./img/SuperMarioBros-back.png"; // La imagen que se muestra cuando la real está oculta
new Vue({
  el: "#app",
  data: () => ({
  ...
  //a partir de aqui introducimos metodos//

  methods: {
    mostrarCreditos() {
      Swal.fire({
        title: "Copyright ©",
        html: `Creado por <a target="_blank" href="http://sevilla2.alumnosdev.com/sr_chikano/">Antonio</a>
                  <br>
                  <strong></strong>
                  <br>
                  
                  <div>Puedes ver mis trabajos <a target="_blank" href="http://sevilla2.alumnosdev.com/sr_chikano/" title="Roundicons">haciendo clíc aquí</a>, ó 
    ...
    indicarFracaso() {
      Swal.fire({
        html: `
                  <img class="img-fluid" src="./img/gameover.gif" alt="Perdiste">
                  <p class="h4">Continue...</p>
                  <audio autoplay src="audio/mario-bros-game-over.mp3"></audio>`,
    ...
    indicarVictoria() {
      Swal.fire({
        title: "¡Ganaste!",
        html: `
                  <img class="img-fluid" src="./img/fuegos.jpg" alt="Ganaste">
                  <img class="img-fluid mario" src="./img/victoria.gif" alt="Ganaste">
                  <br><br><br><br>
                  <p class="h4">Eres un máquina</p>
                  <audio autoplay src="audio/mario-bros-vida.mp3"></audio>`,
    ...
    // Ayudante para mezclar un arreglo este deberemos meterlo
    mezclarArreglo(a) {
      var j, x, i;
